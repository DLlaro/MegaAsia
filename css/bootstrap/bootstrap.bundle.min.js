...
!(function(t, e) {
    ...
    function oe(t) {
        ...
        return i &&
            ...
            (function(t) {
                ...
                var i = ne(t);
                for (
                    qt(i) && (i = i.host); zt(i) && ["html", "body"].indexOf(Wt(i)) < 0;
        ...
        var i = e,
            ...
            w = (function(t, e, i, n) {
                var s =
                    ...
                    (function(t) {
                        var e = Ce(ne(t)),
                            i = ["absolute", "fixed"].indexOf(te(t).position) >= 0 &&
                            zt(t) ?
                            oe(t) :
                            t;
                        return Ft(i) ?
                    ...
                    r = kt.reduce(function(t, i) {
                        return (
                            (t[i] = (function(t, e, i) {
                                ...
                                return (
                                    (r = r || 0),
                                    (a = (a || 0) * s), [bt, _t].indexOf(n) >= 0 ? { x: a, y: r } : { x: r, y: a }
                                );
                            })(i, e.rects, o)),
                            t
                        );
    ...
    class cn extends z {
        ...
        show() {
            ...
            this._queueCallback(
                () => {
                    P.trigger(this._element, this.constructor.eventName("shown")), !1 === this._isHovered && this._leave(),
                        (this._isHovered = !1);
                },
                this.tip,
                this._isAnimated()
